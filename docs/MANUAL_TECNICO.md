...
- El primer administrador se crea al iniciar con `Database__Initialize=true` y los
  secretos `BootstrapAdmin__Email` y `BootstrapAdmin__Password`. No existe una
  contraseña predeterminada en el repositorio.
